...
const viewer = required<HirayaImageViewer>("#viewer"); const empty = required<HTMLElement>("#empty"); const status = required<HTMLElement>("#status"); const zoomOutput = required<HTMLOutputElement>("#zoom"); const operations = new LatestOperation(); const stage = required<HTMLElement>("#stage"); const imageContent = required<HTMLElement>("#image-content"); const loading = required<HTMLElement>("#loading");
