...
export function AppWindow({
  ...
  const headerElements = externalHeaderElements
  ...
  return <section
    ...
    data-full-surface={!windowed || undefined}
    role="dialog"
    aria-modal="false"
  ...
  >
    {(windowed || !hideFocusedHeader) && <header
      ...
      onDoubleClick={(event) => {
        if (windowed && onToggleMaximize && !(event.target as Element).closest(NO_DRAG_SELECTOR)) onToggleMaximize(id);
      }}
