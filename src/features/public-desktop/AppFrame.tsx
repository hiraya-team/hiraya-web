import { TRUSTED_DOCUMENT_MEDIA_CSP, TRUSTED_DOCUMENT_MEDIA_FLAGS } from "@hiraya/app-runtime";
...
export default function PublicAppFrame({ runtime, onNavigation }: { runtime: PublicAppRuntime; onNavigation: () => void }) {
  return <SandboxAppFrame
    ...
    csp={runtime.app.install.appId === SYSTEM_APP_IDS.mediaViewer ? TRUSTED_DOCUMENT_MEDIA_CSP : undefined}
    sandbox={runtime.app.install.appId === SYSTEM_APP_IDS.mediaViewer ? TRUSTED_DOCUMENT_MEDIA_FLAGS : undefined}
