export type AppHistorySettingsPage = "main" | "desktops" | "themes" | "activity" | "apps" | "short-links";
...
export function historySettingsPage(state: unknown): AppHistorySettingsPage {
  ...
  return page === "desktops" || page === "themes" || page === "activity" || page === "apps" || page === "short-links" ? page : "main";
}
